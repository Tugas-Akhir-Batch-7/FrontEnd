<template>
  <!-- <div
    class="flex-shrink-0 p-3 d-fixed d-lg-flex flex-column bg-light menubar"
    style="width: 280px"
  > -->
  <div style="position: relative">
    <button class="btn btn-warning btn-toggle-sidebar" @click="toggleSidebar">
    ...
    <div class=" bg-light menubar" :class="{ active: sidebarActive }">
      <!-- <a href="/" class="mb-3 d-flex align-items-center mb-md-0 me-md-auto link-dark text-decoration-none">
    <span class="fs-4">Sidebar</span>
  </a>
  <hr> -->
      <ul
        class="flex-row p-3 mb-auto overflow-scroll scrollbar-display-none nav nav-pills d-block menu-ul"
      >
        ...
        <RouterLink
          to="/admin/list-guru"
          class="flex-shrink-0 px-4 nav-link link-dark d-flex align-items-center justify-content-start menu-w-h"
        >
